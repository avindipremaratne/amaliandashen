...
//   // Unmute right at the moment "You're Invited" appears in the video
//   // (~8s in), rather than waiting for the video to finish entirely.
//   const handleCue = () => {
//     musicRef.current?.unmute();
//   };
...
//   // than modifying EnvelopeIntro.tsx, we listen for the very first tap
//   // anywhere on the page (which is the envelope tap itself) and use that
//   // moment to start the track muted. It stays silent until handleCue
//   // unmutes it at the 8-second mark.
//   useEffect(() => {
//     const startOnFirstInteraction = () => {
//       musicRef.current?.startMuted();
//       document.removeEventListener('click', startOnFirstInteraction);
...
//     <MemberProvider>
//       {showIntro && (
//         <EnvelopeIntro onComplete={handleIntroComplete} onCue={handleCue} />
//       )}
//       <MusicPlayer ref={musicRef} />
//       <RouterProvider router={router} />
//     </MemberProvider>
