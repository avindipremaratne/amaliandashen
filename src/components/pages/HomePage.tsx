        ...
        <div className="relative z-10 flex flex-col items-center text-center px-4 w-full max-w-4xl">
          ...
          <FadeIn delay={0.6}>
            <div className="flex flex-col items-center gap-2 mt-4 px-4 text-center">
              <p className="text-white/90 font-light uppercase tracking-widest text-base sm:text-lg md:text-2xl lg:text-3xl bodoni-moda-regula font-bodoni-moda">
      ...
      <section className="scroll-mt-24 py-24 bg-stone-50 relative">
        <div className="container mx-auto px-4 flex flex-col items-center">
          ...
          <FadeIn delay={0.2} className="text-center mb-12">
            <h2 className="font-heading text-6xl md:text-8xl text-stone-800 mb-8" style={{ fontFamily: "Ephesis, cursive", fontWeight: 400 }}>
            The Day is Coming!
          </h2>
      ...
      <section id="schedule" className="scroll-mt-24 py-24 bg-stone-100 relative border-t border-stone-200">
        <div className="container mx-auto px-4 max-w-4xl">
          <FadeIn className="text-center mb-16">
            <h2 className="font-heading text-4xl md:text-5xl text-stone-800" style={{ fontFamily: "Ephesis, cursive", fontWeight: 400 }}>
              Timing
            </h2>
          </FadeIn>
