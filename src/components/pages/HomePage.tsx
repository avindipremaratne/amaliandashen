        ...
        <div className="relative z-10 flex flex-col items-center text-center px-4 w-full max-w-4xl">
          ...
          <FadeIn delay={0.6}>
            <div className="flex flex-col items-center gap-2 mt-4">
              <p className="text-white/90 tracking-[0.3em] font-medium uppercase font-montserrat text-2xl md:text-5xl">
                Save the Date
              </p>
              <p className="text-white/90 tracking-[0.2em] text-xs uppercase md:text-5xl">27th August 2026</p>
